...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('orders_order', (
            ...
            ('order_id', self.gf('django.db.models.fields.CharField')(default='ABC', max_length=120, unique=True)),
    ...
    models = {
        ...
        'orders.order': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order_id': ('django.db.models.fields.CharField', [], {'default': "'ABC'", 'max_length': '120', 'unique': 'True'}),
