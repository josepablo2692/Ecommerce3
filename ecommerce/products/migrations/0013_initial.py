...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('products_product', (
            ...
            ('sale_price', self.gf('django.db.models.fields.DecimalField')(null=True, decimal_places=2, blank=True, max_digits=100)),
        ...
        db.create_table('products_variation', (
            ...
            ('price', self.gf('django.db.models.fields.DecimalField')(null=True, decimal_places=2, blank=True, max_digits=100)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
    ...
    models = {
        'products.product': {
            ...
            'sale_price': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'decimal_places': '2', 'blank': 'True', 'max_digits': '100'}),
        ...
        'products.variation': {
            ...
            'price': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'decimal_places': '2', 'blank': 'True', 'max_digits': '100'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['products.Product']"}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '120'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        }
